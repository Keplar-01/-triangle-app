...
class Ui_DataBasePage(object):
    ...
    def retranslateUi(self, DataBasePage):
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("DataBasePage", u"\u041a\u0430\u0442\u0435\u0442 1", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("DataBasePage", u"id", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("DataBasePage", u"\u041a\u0430\u0442\u0435\u0442 2", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("DataBasePage", u"\u0423\u0434\u0430\u043b\u0438\u0442\u044c", None));
        ...
        self.pushButton.setText(QCoreApplication.translate("DataBasePage", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c", None))
